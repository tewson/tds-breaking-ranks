  ...
  <div class="vote">
    ...
    <table class="table is-fullwidth">
      ...
      <tfoot class="has-text-weight-bold">
        <tr>
          <td>Total</td>
          <td>{vote.tallies.taVotes ? vote.tallies.taVotes.tally : 0}</td>
          <td>{vote.tallies.staonVotes ? vote.tallies.staonVotes.tally : 0}</td>
          <td>{vote.tallies.nilVotes ? vote.tallies.nilVotes.tally : 0}</td>
        </tr>
      </tfoot>
    </table>
    <div>
